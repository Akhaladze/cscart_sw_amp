...
if((isset($session['product_data']))&&(!empty($session['product_data']))) {
	/*	fill user cart */
...
if((isset($session['user_data']))&&(!empty($session['product_data']))) {
	/*	update user_data */
...
<head>
	...
	<?php $this->title = $this->params['page_title'];?>
...
<script type="application/json">
      {
        "added": false,
        "product_id": "<?php if(isset($session['product_data']['id'])) {echo $session['product_data']['id'];}?>", 
        "name": "",
        "description": "",
        "product_option": "", 
        "image": "https://amp.akademorto.kz/no_image.png", 
        "product_price": ""
  ...
  <header class="ampstart-headerbar fixed flex justify-start items-center top-0 left-0 right-0 pl2 pr4 pt2 md-pt0">
    <div role="button" aria-label="open sidebar" on="tap:header-sidebar.toggle" tabindex="0" class="ampstart-navbar-trigger  pr2 absolute top-0 pr0 mr2 mt2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" class="block"><path fill="none" d="M0 0h24v24H0z"></path><path fill="currentColor" d="M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z"></path></svg>
      ...
      <a href="https://akademorto.kz" class="text-decoration-none inline-block mx-auto">
      <h5>Академия Ортопедии</h5>
      </a>
    <div class="ampstart-headerbar-fixed center m0 p0 flex justify-center nowrap absolute top-0 right-0 pt2 pr3">
      <div class="mr2">
      </div>
        <a href="/cart" class="text-decoration-none mr2 ampstart-headerbar-fixed-link">
...
<amp-sidebar id="header-sidebar" class="ampstart-sidebar px3  md-flex flex-column justify-content items-center justify-center" layout="nodisplay">
  ...
  <nav class="ampstart-sidebar-nav ampstart-nav">
	...
	<?php
foreach ($this->params['menu_items'] as $item) { ?>
			<li class="ampstart-nav-item "><a class="ampstart-nav-link" href="<?=$item['amp_url']?>"><?=$item['category']?></a></li>
	<?php } ?>
	
         
          <li class="ampstart-nav-item "><a class="ampstart-nav-link" href="https://akademorto.kz/shkola/">Блог</a></li>
          <li class="ampstart-nav-item "><a class="ampstart-nav-link" href="https://akademorto.kz/index.php?dispatch=pickup.view">Контакты</a></li>
    </ul>

     <h3 class="h7 block pt3">Оставайтесь на связи</h3>
		<ul class="ampstart-social-follow list-reset flex justify-around items-center flex-wrap m0 mb4">
    <li>
        <a href="<?php echo FACEBOOK_LINK;?>" target="_blank" class="inline-block p1" aria-label="Link to AMP HTML Facebook"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="23.6" viewBox="0 0 56 55"><title>Facebook</title><path d="M47.5 43c0 1.2-.9 2.1-2.1 2.1h-10V30h5.1l.8-5.9h-5.9v-3.7c0-1.7.5-2.9 3-2.9h3.1v-5.3c-.6 0-2.4-.2-4.6-.2-4.5 0-7.5 2.7-7.5 7.8v4.3h-5.1V30h5.1v15.1H10.7c-1.2 0-2.2-.9-2.2-2.1V8.3c0-1.2 1-2.2 2.2-2.2h34.7c1.2 0 2.1 1 2.1 2.2V43" class="ampstart-icon ampstart-icon-fb"></path></svg></a>
    </li>
    <li>
        <a href="<?php echo INSTAGRAM_LINK;?>" target="_blank" class="inline-block p1" aria-label="Link to AMP HTML Instagram"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 54 54"><title>instagram</title><path d="M27.2 6.1c-5.1 0-5.8 0-7.8.1s-3.4.4-4.6.9c-1.2.5-2.3 1.1-3.3 2.2-1.1 1-1.7 2.1-2.2 3.3-.5 1.2-.8 2.6-.9 4.6-.1 2-.1 2.7-.1 7.8s0 5.8.1 7.8.4 3.4.9 4.6c.5 1.2 1.1 2.3 2.2 3.3 1 1.1 2.1 1.7 3.3 2.2 1.2.5 2.6.8 4.6.9 2 .1 2.7.1 7.8.1s5.8 0 7.8-.1 3.4-.4 4.6-.9c1.2-.5 2.3-1.1 3.3-2.2 1.1-1 1.7-2.1 2.2-3.3.5-1.2.8-2.6.9-4.6.1-2 .1-2.7.1-7.8s0-5.8-.1-7.8-.4-3.4-.9-4.6c-.5-1.2-1.1-2.3-2.2-3.3-1-1.1-2.1-1.7-3.3-2.2-1.2-.5-2.6-.8-4.6-.9-2-.1-2.7-.1-7.8-.1zm0 3.4c5 0 5.6 0 7.6.1 1.9.1 2.9.4 3.5.7.9.3 1.6.7 2.2 1.4.7.6 1.1 1.3 1.4 2.2.3.6.6 1.6.7 3.5.1 2 .1 2.6.1 7.6s0 5.6-.1 7.6c-.1 1.9-.4 2.9-.7 3.5-.3.9-.7 1.6-1.4 2.2-.7.7-1.3 1.1-2.2 1.4-.6.3-1.7.6-3.5.7-2 .1-2.6.1-7.6.1-5.1 0-5.7 0-7.7-.1-1.8-.1-2.9-.4-3.5-.7-.9-.3-1.5-.7-2.2-1.4-.7-.7-1.1-1.3-1.4-2.2-.3-.6-.6-1.7-.7-3.5 0-2-.1-2.6-.1-7.6 0-5.1.1-5.7.1-7.7.1-1.8.4-2.8.7-3.5.3-.9.7-1.5 1.4-2.2.7-.6 1.3-1.1 2.2-1.4.6-.3 1.6-.6 3.5-.7h7.7zm0 5.8c-5.4 0-9.7 4.3-9.7 9.7 0 5.4 4.3 9.7 9.7 9.7 5.4 0 9.7-4.3 9.7-9.7 0-5.4-4.3-9.7-9.7-9.7zm0 16c-3.5 0-6.3-2.8-6.3-6.3s2.8-6.3 6.3-6.3 6.3 2.8 6.3 6.3-2.8 6.3-6.3 6.3zm12.4-16.4c0 1.3-1.1 2.3-2.3 2.3-1.3 0-2.3-1-2.3-2.3 0-1.2 1-2.3 2.3-2.3 1.2 0 2.3 1.1 2.3 2.3z" class="ampstart-icon ampstart-icon-instagram"></path></svg></a>
    </li>
    <li>
        <a href="<?php echo TWITTER_LINK;?>" target="_blank" class="inline-block p1" aria-label="Link to AMP HTML Twitter"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="22.2" viewBox="0 0 53 49"><title>Twitter</title><path d="M45 6.9c-1.6 1-3.3 1.6-5.2 2-1.5-1.6-3.6-2.6-5.9-2.6-4.5 0-8.2 3.7-8.2 8.3 0 .6.1 1.3.2 1.9-6.8-.4-12.8-3.7-16.8-8.7C8.4 9 8 10.5 8 12c0 2.8 1.4 5.4 3.6 6.9-1.3-.1-2.6-.5-3.7-1.1v.1c0 4 2.8 7.4 6.6 8.1-.7.2-1.5.3-2.2.3-.5 0-1 0-1.5-.1 1 3.3 4 5.7 7.6 5.7-2.8 2.2-6.3 3.6-10.2 3.6-.6 0-1.3-.1-1.9-.1 3.6 2.3 7.9 3.7 12.5 3.7 15.1 0 23.3-12.6 23.3-23.6 0-.3 0-.7-.1-1 1.6-1.2 3-2.7 4.1-4.3-1.4.6-3 1.1-4.7 1.3 1.7-1 3-2.7 3.6-4.6" class="ampstart-icon ampstart-icon-twitter"></path></svg></a>
    </li>
</ul>
    <ul class="ampstart-sidebar-faq list-reset m0">
        <li class="ampstart-faq-item"><a href="<?php echo CONTACTS_LINK;?>" class="text-decoration-none">Контакты</a></li>
        <li class="ampstart-faq-item"><a href="<?php echo RETURNS_LINK;?>" class="text-decoration-none">Возвраты</a></li>
        <li class="ampstart-faq-item"><a href="<?php echo ABOUT_PAGE;?>" class="text-decoration-none">О Нас</a></li>
    </ul>
...
<?php /* Корзина и ее содерживое*/?>
 ...
 <div class="col-3 sm-col-2 md-col-2 lg-col-2">
        <amp-img 
			class="commerce-cart-item-image" src="https://amp.akademorto.kz/no_image.png" [src]="{{ image }}" width="1" height="1" layout="responsive" alt="Caliper Brakes" noloading="">
	...
	<div class="cart-item">
	  ...
	  <div class="flex p2 mxn1 md-py3">
        ...
        <a href="<?=DEFAULTPATHTOCARTURL?>" class="ampstart-btn caps center col col-6 mx1">Оформить заказ</a>
      </div>
  </template>
...
<footer class="commerce-footer center">
  <nav class="mx-auto md-mb0 md-pt5 md-pb5">
    <ul class="list-reset flex flex-wrap my0 md-pl4 md-pr4 md-mxn4">
      <li class="pt3 md-pt0 md-px4 col-12 md-col-3 lg-col-2">
         ...
         <ul class="list-reset pb3 md-mx0">
              <li>
                <a class="text-decoration-none" href="<?php echo ABOUT_PAGE;?>">О нас</a>
              </li>
              <li>
                <a class="text-decoration-none" href="<?php echo CONTACTS_LINK;?>">Салоны в Алмате</a>
              </li>
              <li>
                <a class="text-decoration-none" href="<?php echo CONTACTS_LINK2;?>">Салоны в Астане</a>
              </li>
          </ul>
      ...
      <li class="pt3 md-pt0 md-px4 col-12 md-col-3 lg-col-2">
          ...
          <ul class="list-reset pb3 md-mx0">
              <li>
                <a class="text-decoration-none" href="tel:<?php echo TEL_NUM?>"><?=TEL;?></a>
              </li>
              <li>
                <a class="text-decoration-none" href="mailto:<?php echo EMAIL;?>"><?php echo EMAIL;?></a>
              </li>
              <li>
                <a class="text-decoration-none" href="<?php echo CONTACTS_LINK;?>">Все контакты</a>
              </li>
          </ul>
        <hr class="md-hide lg-hide col-12 mx0">
      </li>
    ...
    <h3 class="h7 block pt3"><?=SOCIAL_FOLLOW_MES;?></h3>
<ul class="ampstart-social-follow list-reset flex justify-around items-center flex-wrap m0 mb4">
    <li>
        <a href="<?php echo FACEBOOK_LINK;?>" target="_blank" class="inline-block p1" aria-label="Link to AMP HTML Facebook"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="23.6" viewBox="0 0 56 55"><title>Facebook</title><path d="M47.5 43c0 1.2-.9 2.1-2.1 2.1h-10V30h5.1l.8-5.9h-5.9v-3.7c0-1.7.5-2.9 3-2.9h3.1v-5.3c-.6 0-2.4-.2-4.6-.2-4.5 0-7.5 2.7-7.5 7.8v4.3h-5.1V30h5.1v15.1H10.7c-1.2 0-2.2-.9-2.2-2.1V8.3c0-1.2 1-2.2 2.2-2.2h34.7c1.2 0 2.1 1 2.1 2.2V43" class="ampstart-icon ampstart-icon-fb"></path></svg></a>
    </li>
